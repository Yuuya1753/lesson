...
$(function() {
	$("#submit").click(function() {
		$.ajax({
			url: "http://192.168.33.10:4567/homework29/submit",
			type: 'POST',
			dataType: "json",
			data: {
				text: $("#textarea").val()
	...
	$("#add").click(function() {
		$.ajax({
			url: "http://192.168.33.10:4567/homework29/add",
			type: 'POST',
			dataType: "json",
			data: {
				text: $("#textarea").val(),
	...
	$("#reg_text").click(function() {
		$.ajax({
			url: "http://192.168.33.10:4567/homework29/reg",
			type: 'POST',
			dataType: "text",
			data: {
				text: $("#textarea").val()
	...
	$("#get_text").click(function() {
		$.ajax({
			url: "http://192.168.33.10:4567/homework29/get",
			type: 'GET',
			dataType: "json",
			success: function (result) {
				all_result = result;
